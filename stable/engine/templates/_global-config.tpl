    ...
    feeds:
      ...
      selective_sync:
        ...
        feeds:
          ...
          # Warning: enabling the package sync causes the service to require much more memory to do process the significant data volume. 
          # We recommend at least 4GB available for the container
